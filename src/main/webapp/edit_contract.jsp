		...
		<form action="UpdateContractServlet" method="post" >
              <div class="form-group row form-padding" style=" padding-top: 5px;">
                ...
                <div class="form-padding form-group row">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="reference_number" value="<%= c.getReference_number() %>"
                ...
                <div class="form-group row form-padding">
                  ...
                  <div class="col-sm-5">
                      ...
                      class="form-control" id="receiveddate"  >
                  </div>
              </div>
                <div class="form-group row form-padding">
                  <label for="customer" class="col-sm-3 col-form-label">Customer Details</label>
                  <div class="col-sm-5">
                    <input type="text" name="client_name" value="<%= c.getClient_name() %>"
                ...
                <div class="form-group row form-padding">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="contract_type" value="<%= c.getContract_type() %>"
              ...
              <div class="form-group row form-padding">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="contract_value" value="<%= c.getContract_value() %>"
            ...
            <div class="form-padding form-group row">
              ...
              <div class="col-sm-5">
                <input type="text" name="document_name" value="<%= c.getDocument_name() %>"
